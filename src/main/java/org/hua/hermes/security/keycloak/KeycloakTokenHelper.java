package org.hua.hermes.security.keycloak;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.hua.hermes.security.keycloak.representations.SummarizedGroup;
...
public class KeycloakTokenHelper
{
    ...
    {
        var organizations = getToken().getOtherClaims().get("organization");
